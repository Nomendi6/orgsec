...
This page describes the integration pattern where Keycloak calls an application Person API during login and writes OrgSec person data into a trusted JWT claim.

See [Glossary](../reference/glossary.md) for JWT, IdP, OIDC, and related authorization terms.
...
- [Archive / JWT-Keycloak app](../archive/v1/examples/jwt-keycloak-app.md) - runnable application that consumes the claim.
- [Keycloak Person API](../spring/03-keycloak-person-api.md) - the YAML knobs.
