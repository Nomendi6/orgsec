...
- The cached `PersonDef` is `null` for the supplied person id. Either Redis has no READY snapshot (NOT_READY / generation mismatch) or the person genuinely does not exist.
