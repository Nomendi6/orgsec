...
This is the 1.1.0 runbook for a managed Redis authorization dataset that is empty, NOT_READY, or serving no GET/LIST. It is not a general Redis DBA guide.
...
- Do not run 1.0.x and 1.1.0 against the same keys.
