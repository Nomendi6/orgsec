...
public class CacheWarmer {
    ...
    /** Legacy untyped role store retained for the 1.0.4 preload contract. */
    ...
    /** Legacy untyped role loader retained for the 1.0.4 preload contract. */
    ...
    public int warmupRoles() {
        ...
        if (partyRoleLoader == null && positionRoleLoader == null) {
            // Preserve the 1.0.4 contract for callers that supply one untyped role map.
