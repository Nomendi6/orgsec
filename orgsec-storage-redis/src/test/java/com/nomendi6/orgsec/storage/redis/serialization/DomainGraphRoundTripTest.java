...
class DomainGraphRoundTripTest {
    ...
    @Test
    void roleDefSurvivesRoundTripWithItsResources() {
    ...
    @Test
    void organizationDefSurvivesRoundTripWithItsBusinessRolesAndRoles() {
        ObjectMapper mapper = standardMapper();
    ...
    @Test
    void personDefSurvivesRoundTripWithItsOrganizations() {
        ObjectMapper mapper = standardMapper();
    ...
    @Test
    void strictMapperRoundTripsTheWholeGraphToo() {
    ...
    @Test
    void deserializedResourceDefNeverHasANullPrivilegesList() {
        ObjectMapper mapper = standardMapper();
