...
class RedisCanonicalPrivilegeCodecTest {
    ...
    void standaloneCodecOwnsCanonicalGeneratorConfiguration() throws Exception {
        ...
        try (JsonGenerator generator = externallyConfiguredFactory.createGenerator(output)) {
            ...
            generator.writeRaw('\n');
            generator.writeStringProperty("name", privilege.name);
            generator.writeStringProperty("resourceName", privilege.resourceName);
            generator.writeStringProperty("operation", privilege.operation.name());
            generator.writeBooleanProperty("all", privilege.all);
            generator.writeStringProperty("company", privilege.company.name());
            generator.writeStringProperty("org", privilege.org.name());
            generator.writeBooleanProperty("person", privilege.person);
